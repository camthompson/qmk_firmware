...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    LCTL_T(KC_ESCAPE),KC_A,         KC_S,           KC_D,           KC_F,           KC_G,           HYPR_T(KC_NO),                                  HYPR_T(KC_NO),  KC_H,           KC_J,           KC_K,           KC_L,           KC_SCLN,        LALT_T(KC_QUOTE),
    ...
    LSA_T(KC_ENTER),       KC_LGUI,        KC_LGUI,                                                                                                 KC_BSPC,        KC_BSPC,        KC_SPC
  ),
  [1] = LAYOUT_moonlander(
