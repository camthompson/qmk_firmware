...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    LCTL_T(KC_ESCAPE),KC_A,         KC_S,           KC_D,           KC_F,           KC_G,           KC_HYPR,                                        KC_HYPR,        KC_H,           KC_J,           KC_K,           KC_L,           KC_SCLN,        KC_QUOTE,
    KC_LSFT,        KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLSH,        KC_RSFT,
    KC_GRAVE,       RGB_TOG,        OSL(1),         OSL(2),         KC_LALT,        KC_HYPR,                                                        KC_HYPR,        KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       MO(1),
    KC_ENTER,       KC_LGUI,        KC_LGUI,                                                                                                        KC_BSPC,        KC_BSPC,        KC_SPC
  ),
  [1] = LAYOUT_moonlander(
